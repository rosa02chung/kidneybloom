...
window.I18N = {
  ko: {
    ...
    mc_note: '받는 사람은 링크를 열면 같은 앱에서 읽기 전용으로 봅니다. 보낸 시점의 스냅샷이며, 새로 보내면 갱신돼요.', mc_copied: '링크를 복사했어요 — 카톡·문자에 붙여넣기',
    ...
    mr_keep: '내 폰에 저장', mr_mine: '내 기록으로', mr_start: '나도 시작하기', mr_kept: '저장했어요 — 설정에서 다시 볼 수 있어요', mr_bad: '링크를 읽을 수 없어요', mr_latest: '최근 값', mr_trend: '추이',
    mr_foot: '이 카드는 보낸 사람이 직접 고른 항목의 스냅샷입니다. 의료기기가 아니며, 판단은 담당 의료진에게 있습니다.',
    st_mirrors: '받은 미러 카드', mr_open: '열기', mr_del: '삭제', mr_from: '{name} · {date}',
    // trend
    ...
    imported: '가져왔어요', bad_file: '파일을 읽을 수 없어요', reset_confirm: '모든 기록과 설정을 삭제할까요? 되돌릴 수 없어요.', st_foot: 'My Beanie v0.4 · 개인 건강기록 도구',
    // tabs
  ...
  en: {
    ...
    mc_note: 'The recipient opens the link in this same app, read-only. It is a snapshot from when you sent it; send again to update.', mc_copied: 'Link copied — paste it in a message',
    ...
    mr_keep: 'Keep on my phone', mr_mine: 'My own records', mr_start: 'Start my own', mr_kept: 'Saved — find it again in Settings', mr_bad: 'Could not read this link', mr_latest: 'Latest', mr_trend: 'Trend',
    ...
    st_mirrors: 'Received mirror cards', mr_open: 'Open', mr_del: 'Delete', mr_from: '{name} · {date}',
    ...
    imported: 'Imported', bad_file: 'Could not read the file', reset_confirm: 'Delete all records and settings? This cannot be undone.', st_foot: 'My Beanie v0.4 · personal health-record tool',
