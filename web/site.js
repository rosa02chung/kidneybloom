...
(() => {
  ...
  const pages = [['index.html', '홈', 'Home'], ['problem.html', '문제와 시장', 'Problem & Market'], ['product.html', 'My Beanie', 'My Beanie'], ['family.html', '가족', 'Family'], ['dialysis.html', '투석', 'Dialysis'], ['strategy.html', '전략과 사업구조', 'Strategy'], ['company.html', '회사와 연구', 'Company & Research']];
